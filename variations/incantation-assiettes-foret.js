...
// 
    void main(void) {
        ...
        x += tan(i * 0.00001 + tan(cos(i * 200. + x * tan(i * 1e3)) * 4.) + t * 30.) * 2000.5;
        y += tan(i * 0.00001 + tan(sin(i * 200. + y * tan(i * 1e3)) * 4.) + t * 30.) * 2000.5;
        // x += sin(pow(x, i * 1e-4));
        // y += sin(pow(y, i * 1e-4));
        x += cos(t * 15.75e1) * i * 2e-2;
        y += sin(t * 15.75e1) * i * 2e-2;
        // x += 1000. * cos(t * 4e1) * 1.;
        // y += 1000. * sin(t * 4e1) * 1.;
        x *= 1.9e-3;
        y *= 1.9e-3;
