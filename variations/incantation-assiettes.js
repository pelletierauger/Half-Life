...
// 
    void main(void) {
        ...
        float x = cos(tan(i * 1.5e-7) * 1e1 * i) * i * 16e-3;
        float y = sin(tan(i * 1.5e-7) * 1e1 * i) * i * 16e-3;
        x += tan(tan(cos(i * 200. + x * tan(i * 1e3)) * 4.) + t * 30.) * 2000.5;
        y += tan(tan(sin(i * 200. + y * tan(i * 1e3)) * 4.) + t * 30.) * 2000.5;
        // x += sin(pow(x, i * 1e-4));
        // y += sin(pow(y, i * 1e-4));
