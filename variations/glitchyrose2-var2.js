...
// 
    void main(void) {
        ...
        float x = cos(i + sin(i * 1e-4 + i * 1e-4)) * i * 1e-5 * 2.;
        float y = sin(i + sin(i * 1e-4 + i * 1e-4)) * i * 1e-5 * 2.;
        x += sin(x * 0.25 * sin(t * 1e1) * sin(i * 3. + x * 0.5e2) + sin(x * 1e-2)) * 0.75;
        y += sin(y * 0.25 * sin(t * 1e1) * sin(i * 3. + x * 0.5e2) + sin(x * 1e-2)) * 0.75;
        x += tan(cos(i * 69. * tan(i * 1e3)) * 1e7 * sin(1e-5) + t * 1e1) * 2.5;
        y += tan(sin(i * 69. * tan(i * 1e3)) * 1e7 * sin(1e-5) - t * 1e1) * 2.5;
        //         x *= 0.25 * 44.5;
//         y *= 0.25 * 44.5;
