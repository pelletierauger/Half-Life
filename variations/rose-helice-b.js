...
// 
    void main(void) {
        ...
        x += sin(sin(x * 0.25 * sin(i * 3. + t * 2e1)) * i * 4e5) * 0.75;
        y += sin(cos(y * 0.25 * sin(i * 3. + t * 2e1)) * i * 4e5) * 0.75;
        // x += tan(tan(cos(i * 69. * tan(i * 1e3)) * 4.) + t * 30.) * 1000.5;
        // y += tan(tan(sin(i * 69. * tan(i * 1e3)) * 4.) + t * 30.) * 1000.5;
