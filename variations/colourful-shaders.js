...
//         gl_FragColor.g *= 0.525;
        ...
        // gl_FragColor.rgb = gl_FragColor.rrr * 1.;
                        gl_FragColor.rgb = mix(gl_FragColor.rgb, gl_FragColor.rrr, 0.55) * 1.1;
                     // gl_FragColor = gl_FragColor.gbra;
...
//         gl_FragColor = gl_FragColor.gbga;
        gl_FragColor.rgb = vec3(1.0) - gl_FragColor.rgb;
             gl_FragColor = gl_FragColor.grba * 1.5;
//         gl_FragColor.g *= 0.525;
        gl_FragColor.b *= 0.35;
        // gl_FragColor.rgb = gl_FragColor.rrr * 1.;
...
//         gl_FragColor.g *= 0.525;
        // gl_FragColor.b *= 0.5;
        // gl_FragColor.g += 0.4;
        gl_FragColor.rgb = mix(gl_FragColor.rgb, gl_FragColor.rrr, 0.55);
...
//     varying vec2 center;
    ...
    void main(void) {
        ...
        float rando = rand(pos);
        // gl_FragColor = vec4(1.0, (1.0 - dist_squared * 40.) * 0.6, 0.0, alpha + ((0.12 - dist_squared) * 4.) - (rando * 0.2));
        gl_FragColor = vec4(1.0, 0.4 - dist_squared, 0.0 + alpha * 120., ((3. - dist_squared * 24.0 * (0.25 + alph) - (rando * 1.1)) * 0.045 + alpha)) * 1.0025;
//         gl_FragColor = gl_FragColor.gbga;
        gl_FragColor.rgb = vec3(1.0) - gl_FragColor.rgb;
             gl_FragColor = gl_FragColor.grba;
//         gl_FragColor.g *= 0.525;
        // gl_FragColor.b *= 0.5;
        // gl_FragColor.g += 0.4;
                gl_FragColor.rgb = mix(gl_FragColor.rgb, gl_FragColor.rrr, 0.55) * 1.5;
        // gl_FragColor.rgb = gl_FragColor.rrr * 1.;
        // gl_FragColor.gr *= 0.5;
...
//         gl_FragColor.g *= 0.525;
        ...
        // gl_FragColor.g += 0.4;
        // gl_FragColor.rgb = gl_FragColor.rrr * 1.;
                        gl_FragColor.rgb = mix(gl_FragColor.rgb, gl_FragColor.rrr, 0.35) * 1.05;
