...
// 
    void main(void) {
        ...
        x += tan(tan(cos(i * 69. * tan(i * 1e3)) * 1e2) * 1. * t) * 1000.5;
        y += tan(tan(sin(i * 69. * tan(i * 1e3)) * 1e2) * 1. * t) * 1000.5;
        x += sin(y * i * 1e1 * 0.25) * 2e10;
        y += sin(y * i * 1e1 * 0.25) * 2e10;
...
//         gl_FragColor.g *= 0.525;
        ...
        // gl_FragColor.rgb = gl_FragColor.bbb * 1.;
    }
    // endGLSL
`;
incantation.init();
...
void main() {
    ...
    if (sin(uv.y * 50. * 0.5) + sin(uv.y * 10. * 0.5) + sin(uv.y * 10. * 0.5 * tt) < -0.0) {
        ...
        // gl_FragColor = texture2D(u_texture, vv * 0.0625 * 0.5);
        gl_FragColor = texture2D(u_texture, v_texcoord + sin(vv * 1e-5 * t) * 0.);
    }
