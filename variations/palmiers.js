...
// 
    void main(void) {
        ...
        float x = cos(i * 0.5e1 * 0.5) * pow(i, 4.) * 8e-16;
        float y = sin(i * 0.5e1 * 0.5) * pow(i, 4.) * 8e-16;
        // x += cos(x * 1e-2) + cos(i * 2690. * tan(i * 4e-4)) * 1.;
        // y += sin(y * 1e-2) + sin(i * 2690. * tan(i * 4e-4)) * 1.;
        x += tan(i * 0.00001 + (cos(i * 80.) * 4.) + t * 1.) * 3000.5;
        y += tan(i * 0.00001 + (sin(i * 80.) * 4.) + t * 1.) * 3000.5;
        //         x *= 0.25 * 44.5;
        //         y *= 0.25 * 44.5;
...
//         float y = sin(i) * i * 1e-5 * 2.;
        gl_Position = vec4(x * 0.58 * 1e-3, y * 1e-3, 0.0, 1.0);
