...
// 
    void main(void) {
        ...
        x += tan(tan(cos(i * 69. * tan(i * 1e3)) * 1e2) + t * 20.) * 1000.5;
        y += tan(tan(sin(i * 69. * tan(i * 1e3)) * 1e2) + t * 20.) * 1000.5;
        x += sin(pow(x, i * 1e-4) + y * i * 1e-2 * 0.125) * 2e10;
        y += sin(pow(y, i * 1e-4) + y * i * 1e-2 * 0.125) * 2e10;
